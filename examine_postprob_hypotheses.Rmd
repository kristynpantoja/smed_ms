...
- The problem is that we don't see $E[P(H_\ell | y, \mathbf{D}_{MED}) | H_\ell, \mathbf{D}_{MED}] > E[P(H_\ell | y, \mathbf{D}_{space}) | H_\ell, \mathbf{D}_{space}]$ (in fact we see the opposite, $E[P(H_\ell | y, \mathbf{D}_{MED}) | H_\ell, \mathbf{D}_{MED}] < E[P(H_\ell | y, \mathbf{D}_{space}) | H_\ell, \mathbf{D}_{space}]$, which we don't want!).
    ...
    ```{r, echo = FALSE}
numSims = 100
fast_exppostprobs = suppressWarnings(calcExpPostProbH_2d(fast_S5, N, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
space_exppostprobs = suppressWarnings(calcExpPostProbH_2d(space_filling, N, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
...
x0_exppostprobs = suppressWarnings(calcExpPostProbH_2d(x0, 1, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
x1_exppostprobs = suppressWarnings(calcExpPostProbH_2d(x1, 1, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
...
d0_exppostprobs = suppressWarnings(calcExpPostProbH_2d(d0, newN, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
d1_exppostprobs = suppressWarnings(calcExpPostProbH_2d(d1, newN, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e, numSims, type = type, log_space = FALSE))
...
mean(d0_simEvidenceH0_YH0) * 10e-57 # E[f(y | H0, D0)] for y generated from H0
```
...
mean(d0_simEvidenceH1_YH0) * 10e-57 # E[f(y | H1, D0)] for y generated from H0
```
