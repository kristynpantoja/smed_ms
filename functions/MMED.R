...
################################################################################
# generate MMED with no input data
################################################################################
...
# f_min_nodata
f_min_mmed = function(
  candidate, D, k, mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, 
  f0, f1, type, var_margy0, var_margy1, p, alpha, buffer, log_space = FALSE){
  if(log_space == FALSE) {
    result = q_mmed(candidate, mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, 
               f0, f1, type, var_margy0, var_margy1, p, alpha, buffer)^k * 
      sum(sapply(D, function(x_i) (q_mmed(x_i, mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, 
...
# generate_MMED_nodata_oneatatime
MMED = function(
...
# f_min_fast_nodata = function(
#   candidate_jk, D_k, gamma_k, mean_beta0, mean_beta1, var_beta0, var_beta1, 
#   var_e, f0, f1, type, var_margy0, var_margy1, p, alpha, buffer){
#   
...
# }
# 
# generate_MMED_nodata_fast = function(
#   mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, 
...
# }
# 
# MMED_nodata_oneatatime_2d = function(
#   mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, 
#   f0 = NULL, f1 = NULL, type = NULL, N = 11, numCandidates = 10^5, k = 4, 
