...
q_mmed = function(
  x, mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, f0, f1, type, 
...
q_vs = function(
  x, indices0, indices1, postmean0, postmean1, postvar0, postvar1, var_e, p, 
  alpha = 1
){
...
q_gpvs = function(
  x, Kinv0, Kinv1, indices0, indices1, initD0, initD1, y, var_e, type, l, p, 
  alpha = 1
){
  if(length(type) != 2) stop("type should be vector with length == 2")
