...
#                                    numSims = 50, type = NULL, #log_space = FALSE, 
#                                seed = 123){
#   set.seed(seed)
#   # if(log_space == FALSE){
#     # --- Y simulated from H0 --- #
...
#     simPostH1 = simEvidenceH1_YH0 / (simEvidenceH0_YH0 + simEvidenceH1_YH0)
#     # calculate bayes factor
...
calcExpPostProbH_2d_v2 = function(D, N, mean_beta0, mean_beta1, var_mean0, var_mean1, var_e,
                               numSims = 50, type = NULL, seed = 123){
  set.seed(seed)
  # --- Y simulated from H0 --- #
  simY_H0 = simulateY(D, N, mean_beta0, var_mean0, var_e, numSims, type = type[1], seed)
  simEvidenceH0_YH0_elts = matrix(rep(NA, numSims*N), N, numSims)
