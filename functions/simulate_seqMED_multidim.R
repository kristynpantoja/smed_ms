...
simulate_seqMED_multidim = function(mean_beta_full, beta_true = NULL, indices_true = NULL, 
  ...
  for(t in 1:numSeq){
    ...
    Dt = add_MED_ms_oneatatime_data_multidim(initD = D, inity = y, mean_beta_full, beta_true, indices_true, 
