...
# purpose: to test seqmedgp for scenario 6:
#   squared exponential vs. periodic,
#   where the true function is matern
#   (as opposed to comparing a matern to a periodic, where the true function is 
#     squared exponential, like in scenario 5)
...
################################################################################
# Scenario 6: Squared exponential vs. periodic, true = matern
################################################################################
...
if(!is.null(sigmasq_measuremt)){
  y_seq_mat = y_seq_mat + matrix(rnorm(numx * numSims, 1, sqrt(sigmasq_measuremt)), 
