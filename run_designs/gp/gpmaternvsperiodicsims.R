...
saveRDS(train1sims, paste(output_home,"mvp_nonseq_train1sims.rds", sep = ""))
...
train2sims = list("grid" = x_seq,
                  ...
                  "logJointEvid01sf" = logJointEvid0sf_vec - logJointEvid1sf_vec,
                  "logJointEvid01unif" = logJointEvid0unif_vec - logJointEvid1unif_vec)
saveRDS(train2sims, paste(output_home,"mvp_nonseq_train2sims.rds", sep = ""))
...
train3sims = list("grid" = x_seq,
                  ...
                  "logJointEvid01sf" = logJointEvid0sf_vec - logJointEvid1sf_vec,
                  "logJointEvid01unif" = logJointEvid0unif_vec - logJointEvid1unif_vec)
saveRDS(train3sims, paste(output_home,"mvp_nonseq_train3sims.rds", sep = ""))
...
train4sims = list("grid" = x_seq,
                  ...
                  "logJointEvid01sf" = logJointEvid0sf_vec - logJointEvid1sf_vec,
                  "logJointEvid01unif" = logJointEvid0unif_vec - logJointEvid1unif_vec)
saveRDS(train4sims, paste(output_home,"mvp_nonseq_train4sims.rds", sep = ""))
