...
xmax = 1
alpha = 1
greedy_N50_k4_p2_ex3 = MED_ms_oneatatime(mu0, mu1, V0, V1, sigmasq, f0, f1, type, N,
...
###
hist(greedy_N50_k4_p2_ex3, probability = T, ylim = c(0, 2.5), breaks = 10)
...
xmax = 1
alpha = 1
greedy_N50_k2_p1_ex3 = MED_ms_oneatatime(mu0, mu1, V0, V1, sigmasq, f0, f1, type, N,
                                numCandidates, k, xmin, xmax, p = p, alpha = alpha)
...
f_dens_curve2 = function(x) (1/integratefn_int_const) * unnormalized_f_dens_curve(x)
###
hist(greedy_N50_k2_p1_ex3, probability = T, ylim = c(0, 2.5), breaks = 10)
curve(f_dens_curve2, add = T)
...
k = 2
p = 1
greedy_N50_k2_p1_ex1 = MED_ms_oneatatime(mean_beta0, mean_beta1, var_mean0, var_mean1, var_e,
...
f_dens_curve2 = function(x) (1/integratefn_int_const) * unnormalized_f_dens_curve(x)
###
hist(greedy_N50_k2_p1_ex1, probability = T, ylim = c(0, 2.5), breaks = 10)
curve(f_dens_curve2, add = T)
