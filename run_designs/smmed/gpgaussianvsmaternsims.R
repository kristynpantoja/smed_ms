...
saveRDS(train1sims, paste(output_home,"gaussianvsmatern_train1sims.rds", sep = ""))
...
train2sims = list("grid" = x_seq,
                  ...
                  "RSS01sf_vec" = RSS01sf_vec,
                  "logLR01pred_sf_vec" = logLR01pred_sf_vec)
saveRDS(train2sims, paste(output_home,"gaussianvsmatern_train2sims.rds", sep = ""))
...
train3sims = list("grid" = x_seq,
                  ...
                  "RSS01sf_vec" = RSS01sf_vec,
                  "logLR01pred_sf_vec" = logLR01pred_sf_vec)
saveRDS(train3sims, paste(output_home,"gaussianvsmatern_train3sims.rds", sep = ""))
...
train4sims = list("grid" = x_seq,
                  ...
                  "RSS01sf_vec" = RSS01sf_vec,
                  "logLR01pred_sf_vec" = logLR01pred_sf_vec)
saveRDS(train4sims, paste(output_home,"gaussianvsmatern_train4sims.rds", sep = ""))
