...
plot(x = smmed1$D, smmed1$y)
curve(fT, add = T)

# #simulate_seqMED args
# true_beta = betaT
# true_type = typeT
# mean_beta0 = mu0
# mean_beta1 = mu1
...
# # f0 = NULL, f1 = NULL
# type = type01
# # numCandidates = 10^5, k = 4, xmin = 0, xmax = 1, p = 1, numSeq = 5, N_seq = 10, alpha_seq = NULL, buffer_seq = 0, wasserstein0 = 1, genCandidates = 1, seed = NULL
# buffer_seq = 0
# wasserstein0 = 1
# genCandidates = 1
# seed = NULL
...
# # add_MED_ms_oneatatime_data args
# initD = D
# # y, mean_beta0, mean_beta1, var_beta0, var_beta1, var_e, f0 = NULL, f1 = NULL, type = NULL, 
# N2 = N_seq[t]
...
# initD = D
# inity = y
# # mean_beta_full, beta_true = NULL, indices_true = NULL, indices0, indices1, mean_beta0 = NULL, mean_beta1 = NULL, var_e = 1, var_beta = NULL, var_beta0 = NULL, var_beta1 = NULL,
# N2 = N_seq[t]
# # xmin = 0, xmax = 1, numCandidates = 10^5, k = 4, p = 1,
# alpha = alpha_seq[t]
# buffer = buffer_seq[t]
# # candidates = NULL, wasserstein0 = 1, genCandidates = 1
# log_space = FALSE
...
smmed_multidim = simulate_seqMED_multidim(mu_full, betaT, indicesT, indices0, indices1, mu0, mu1, 
                         sigmasq, sigmasq01, V0, V1, xmin, xmax, numCandidates, k, p,
                         initD, inity, numSeq, N_seq, seed = 12)
smmed_multidim$postmean0
betaT
plot(smmed_multidim$postmean0[1, ], smmed_multidim$postmean0[2, ],
     xlim = range(smmed_multidim$postmean0[1, ], betaT[1]), ylim = range(smmed_multidim$postmean0[2, ], betaT[2]))
# plot(betaT[1], betaT[2], xlim = range(smmed_multidim$postmean0, betaT), ylim = range(smmed_multidim$postmean0, betaT))
text(smmed_multidim$postmean0[1, ], smmed_multidim$postmean0[2, ], labels = 1:numSeq, pos = 4)
points(betaT[1], betaT[2], col = 2)

Ntot = numSeq * N_seq + initN
betaT
smmed_postmean0 = postmean(y = smmed_multidim$y, smmed_multidim$D[ , indices1], N = Ntot, 
                           mu1, V1, var_e, type = NULL, diagPrior = TRUE)
smmed_rss = sum((betaT - smmed_postmean0)^2)

# vs. randomly selected data?
x_random = matrix(runif(n = pfull * Ntot, min = xmin, max = xmax), 
                  nrow = Ntot, ncol = pfull)
y_random = simulateY_multidim(x_random[ , indicesT], Ntot, betaT, sigmasq, 1, seed = 12)
rand_postmean0 = postmean(y = y_random, x_random[ , indices1], N = Ntot, mu1, V1, var_e, type = NULL, diagPrior = TRUE)
rand_rss = sum((betaT - rand_postmean0)^2)
#
...
# 
# # 
# # # simulate_seqMED_multidim
# # mean_beta_full, beta_true = NULL, indices_true = NULL, 
...
# # initD, inity, mean_beta_full, beta_true = NULL, indices_true = NULL, 
# # indices0, indices1, mean_beta0 = NULL, mean_beta1 = NULL, 
# # var_e = 1, var_beta = NULL, var_beta0 = NULL, var_beta1 = NULL,
...
# # 
# # initD = D, inity = y, mean_beta_full, beta_true, indices_true, 
...
# # wasserstein0, genCandidate
# # 
# # D, y, mean_beta_full, beta_true = NULL, indices_true = NULL, 
# # indices0, indices1, mean_beta0 = NULL, mean_beta1 = NULL, 
# # var_e = 1, var_beta0, var_beta1, N_seq[t], 
